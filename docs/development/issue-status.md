...
| 区分             | Issue                                                                          | 現状・次の条件                                                                                                                                 |
| ---------------- | ------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| 実装中           | [#28 一覧絞り込み・一括状態変更](https://github.com/rytich/play-cms/issues/28) | PR #27統合・#24終了済み。[PR #29](https://github.com/rytich/play-cms/pull/29)で動画の公開/非公開、未使用キーの有効/無効を最大100件ずつ操作する |
...
| 後続保守         | [#31 checkout実行基盤の警告](https://github.com/rytich/play-cms/issues/31)     | #28を止めない。専用PRで公式互換性確認とSHA固定の更新を行う                                                                                     |
...
関連: [一括操作計画](../superpowers/plans/2026-09-09-bulk-management-implementation.md)、[開発手順](workflow.md)、[管理先行と公開ゲート](admin-first-prototype.md)。
