/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dfce134fde07ffd4becbd8930ef8e3f9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLAY_LOCAL_ONLY">> {}
}
